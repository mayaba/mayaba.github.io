...
'use strict';
    ...
    /* ============================================================ */
    var certificationSlider = new Swiper('.certifcations-slider .swiper-2', {
        spaceBetween: 30,
        slidesPerView: 2,
        loop: true,
        speed: 800,
        ...
        navigation: {
            nextEl: '#certification .button-next-2',
            prevEl: '#certification .button-prev-2',
        },
        on: {
            init: function() {
                $('.certifications-slider-navigation .counter-2').html(
                    '<span class="text-theme">' +
                    (this.realIndex + 1) +
                    '</span>' +
                    '/' +
